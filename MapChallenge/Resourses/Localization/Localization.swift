...
struct Localization {
    ...
    static let tempMessage = "TEMP_MESSAGE".localized
    static let windMessage = "WIND_MESSAGE".localized
    static let rainMessage = "RAIN_MESSAGE".localized
    static let humidityMessage = "HUMIDITY_MESSAGE".localized
}
